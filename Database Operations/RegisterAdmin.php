...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $confirmPassword = $_POST['confirm_password'];
        if ($password != $confirmPassword) {
            ...
            $sql = "INSERT INTO Admin (`admin_id`, `password`) VALUES ('$teacher_id','$hashedPassword')";
            try {
        ...
        <div class="container">
            <div class="form">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                    ...
                    <label for="teacher_id">Enter Admin ID</label><br>
                    <input required type="text" name="teacher_id" placeholder="Enter the AdminID"><br>
                   ...
                   <button style='background-color:blue; color:white' type="button" id='go' onClick='viewAdmins()'>View Admins</button><br>
                    <a href="adminLogin.php">Already registered? <span style="color:blue">Sign in </span><i class="fas fa-sign-in-alt"></i></a> <!-- Link to login page --><br>
                </form>
            </div>
